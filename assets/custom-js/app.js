...
/*jshint sub:true*/
var app = angular.module('swinApp', ['ngRoute', 'home', 'login', 'adminLogin', 'userpage', 'editProfile', 'changePassword', 'registration', 'upload', 'manageVideos', 'video', 'resetPassword', 'admin', 'channel', 'firebase', 'toaster', 'ngAvatar']);
